...
**「我没什么好藏的，需要这么小心吗？」**
**这不是「藏」，是信息边界。** 有些信息给出去就收不回来，和有没有秘密无关。

**「改了昵称和头像就够了吗？」**
**不够。** 邮箱、手机号、发言风格、活跃时间都可能关联。

**「GitHub 仓库里删掉就够了？」**
**不够。** git 历史会保留。**改过一次不代表删掉了。**

**「照片元数据是什么？」**
部分相机与手机拍的照片带 GPS 坐标。**上传前先清除。**
...
| 痕迹 | 说明 | 处理 |
| --- | --- | --- |
| **公开代码仓库** | commit 历史、README、issue 里可能留下真实姓名、邮箱、城市 | **git 历史会保留**，删除文件不够 |
| **社交账号关联** | 同一头像、昵称、邮箱会把不同平台串起来 | 分层使用 |
| **照片元数据** | 部分照片带 GPS 坐标 | 上传前清除 |
| **旧账号发言** | 搜索引擎和存档站点可能还留着 | 定期自查 |
| **公开发布的日程与定位** | 连续发布某地点 = 公开活动范围 | 避免连续发布同一地点 |
| **实名信息变更前后的混用** | 新旧证件、新旧账号同时活跃会造成关联 | 尽快统一 |
| **发言风格** | 独特的表达习惯也可能被识别 | 难以完全避免 |
| **活跃时间** | 长期固定在某个时区活跃 | — |
...
| 社群里分享用药经历很常见 | 但那是公开发言，**可以讲经验，不必贴出具体剂量与检查单** |
| 需要病假、证明材料时 | **尽量只提供办理事项所需的那一页** |
| 提交给单位或学校时 | 可以打码或只给必要部分 |

## 线下安全

| 场景 | 做法 |
| --- | --- |
| **第一次见网友** | 公共场所、白天、告知他人、手机有电 |
| **就医时** | 可以带陪同的人，多数医院允许 |
| **住宿与合租** | 连锁酒店或独立租住更省心 |
| **遇到盘问或刁难** | **不需要向陌生人解释自己的身份** |
| **遇到威胁或跟踪** | **优先处理人身安全**，必要时报警 |
...
**本站不复述热线号码与具体联系方式**，因为会变。

| 入口 | 说明 |
| --- | --- |
| [公益组织](https://mtf.wiki/zh-cn/docs/useful-info/organizations) | 上游名单 |
| [常见法律问题索引](/wiki/legal-faq-index/) | 本站整理 |
| [危机资源与紧急情况](/wiki/crisis-resources/) | 紧急情况 |
| [个人信息与隐私保护](/wiki/privacy-law/) | 被泄露的处理 |

## 一个年度自查清单

- [ ] 搜索自己的常用昵称、邮箱、手机号
- [ ] 检查社交账号的隐私设置与可见范围
- [ ] 检查公开仓库里的个人信息（**含 commit 历史**）
- [ ] 检查旧账号是否还活跃
- [ ] 检查照片是否有定位信息
- [ ] 确认紧急联系人信息是最新的
- [ ] 检查绑定了实名信息的账号清单
